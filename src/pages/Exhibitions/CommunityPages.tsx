...
export function ExhibitionModeration(){
  ...
  return <Page title="공개 심사 · 신고 관리" description="전시 제목·소개·대표 이미지를 확인하고 공개 여부를 결정하세요."><Link to="/admin/exhibitions">← 홈 노출 관리</Link><Result {...access}/>{allowed&&<>
