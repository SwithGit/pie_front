...
export const PwFindForm = styled.div`
  margin-top: 30px;
  display: flex;
  flex-direction: column;
  align-items: center;
  ...
  padding: 20px;
`;
export const PwResetForm = styled(PwFindForm)`
  margin-top: 30px;
`;

export const PwFindInfoSecond = styled.div`
  font-size: 16px;
  margin-top: 24px;
  text-align: left;
  width: 100%;
  color: #223345;
`;
export const PwFindInfo = styled.div`
  font-size: 16px;
  margin-bottom: 10px;
  text-align: left;
  width: 100%;
  color: #223345;
`;
export const PwFindInfoBold = styled(PwFindInfo)`
  color: #c4c4c4;
  margin-top: -7px;
  font-size: 14px;
  margin-left: 10px;
...
`;
export const PwFindButton = styled(IdFindButton)``;
